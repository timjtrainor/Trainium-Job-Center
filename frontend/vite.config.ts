    ...
    return {
      ...
      resolve: {
        alias: {
          ...
          'react-grid-layout/css/styles.css': path.resolve(__dirname, 'src/components/interview/interview-copilot/shims/react-grid-layout.css'),
          'react-grid-layout': path.resolve(
              __dirname,
              'src/components/interview/interview-copilot/shims/react-grid-layout.tsx',
          ),
        }
      },
      test: {
