...
import { LoadingSpinner, CheckIcon, SparklesIcon, TrashIcon } from '../shared/ui/IconComponents';
...
export const ContactModal = (props: ContactModalProps): React.ReactNode => {
    ...
    const handleGenerate = async () => {
        ...
        if (!prompt || !activeNarrative) {
            setGenerationError('Strategic messaging prompt or active narrative is not available.');
            return;
        }
