  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <div>
           <label htmlFor="companyName" className="block text-sm font-medium text-slate-700 dark:text-slate-300">Company Name <span className="text-red-500">*</span></label>
            <input type="text" id="companyName" name="companyName" value={details.companyName} onChange={handleChange} disabled={isLoading}
             className={inputClass} />
        </div>
        <div>
           <label htmlFor="jobTitle" className="block text-sm font-medium text-slate-700 dark:text-slate-300">Job Title <span className="text-red-500">*</span></label>
        ...
        <div className="sm:col-span-2">
           <label htmlFor="jobLink" className="block text-sm font-medium text-slate-700 dark:text-slate-300">Job Posting Link</label>
            <input type="url" id="jobLink" name="jobLink" value={details.jobLink} onChange={handleChange} disabled={isLoading}
             className={inputClass} placeholder="https://company.com/jobs/123" />
        </div>
        <div>
