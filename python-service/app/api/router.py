...
from .v1.endpoints.ai import router as ai_router
from .v1.endpoints.interview_strategy import router as interview_strategy_router
...
api_router.include_router(ai_router, prefix="/ai", tags=["AI Execution"])
api_router.include_router(interview_strategy_router, prefix="/interview", tags=["Interview Strategy"])
