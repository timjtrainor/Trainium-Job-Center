...
@CrewBase
class JobPostingFitCrew:
    """
    Evaluate a job posting through multiple personas to determine how well it aligns with the candidate’s skills, goals, and values.
    - Provide insider-style insights into the hiring company’s culture, expectations, and risks.
    - Advise on practical fit factors including compensation, lifestyle alignment, and career growth potential.
    - Highlight opportunities to strengthen the candidate’s resume, cover letter, or interview preparation for this role.
    - Deliver a clear, boolean recommendation (pursue / do not pursue) with supporting rationale from advisory, motivational, and decision personas.
    - Save the candidate time and effort by surfacing only roles that justify deeper engagement.
    """
