...
class LLMRouter:
    ...
    def __init__(self, preferences: str = "ollama:llama3.3,openai:gpt-4o-mini,gemini:gemini-1.5-flash"):
        """Initialize router with provider preferences.
        
        Args:
            preferences: Comma-separated list of provider:model pairs in preference order.
                        e.g. "ollama:llama3.3,openai:gpt-4o-mini,gemini:gemini-1.5-flash"
        """
