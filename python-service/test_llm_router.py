...
class TestLLMRouter:
    ...
    def test_router_initialization(self):
        ...
        preferences = "ollama:llama3.3,openai:gpt-4o-mini"
        router = LLMRouter(preferences)
        
        assert len(router.providers) == 2
        assert router.providers[0] == ("ollama", "llama3.3")
    ...
    def test_preference_parsing(self):
        ...
        providers = router._parse_preferences("ollama:llama3.3,openai:gpt-4")
        assert providers == [("ollama", "llama3.3"), ("openai", "gpt-4")]
    ...
    def test_client_creation(self, mock_create_client):
        ...
        router = LLMRouter("ollama:llama3.3")
        
        # First call should create client
        client = router._get_client("ollama", "llama3.3")
        assert client == mock_client
        mock_create_client.assert_called_once_with("ollama", "llama3.3", host="http://localhost:11434")
        
        # Second call should use cached client
        mock_create_client.reset_mock()
        client2 = router._get_client("ollama", "llama3.3")
    ...
    def test_generate_with_fallback(self, mock_create_client):
        ...
        router = LLMRouter("ollama:llama3.3,openai:gpt-4")
